...
define(
  ...
  function (oj, ko, $) {
    ...
    function DashboardViewModel() {
      ...
      self.newItem = ko.observableArray([]);         //holds data for the create item dialog
      ...
      var RESTurl = "https://apex.oracle.com/pls/apex/oraclejet/lp/activities/"; //REST Endpoint
      ...
      self.selectedActivityChanged = function (event) {
        ...
        if (event.detail.value.length != 0) {
          ...
          function parseItem(response) {
            ...
            if (response) {
              //if the response contains itemsm pick the first one
